...
const PartyForm = (props) => {
  ...
  const partyByUserId = {
    party_name: props.party.party_name,
    guests: props.party.guests,
    theme: props.party.theme,
    date: props.party.date,
    budget: props.party.budget,
  ...
  const handleSubmit = e => {
    if (validationForm()) {
      props.addParty(props.history, partyByUserId)
    } else {
  ...
  return (
    <>
      <div>
        {console.log('preps party form', props)}
